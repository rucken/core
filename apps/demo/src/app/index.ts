...
export const RuckenDemoShareds: any[] = [DemoRoutes, RuckenDemoRuI18n, DemoHttpHelper, DemoEndpointHelper, DemoHomePageRoutes, DemoThemesPageRoutes, DemoAccountPageRoutes, DemoProfileFrameRoutes, DemoAdminPageRoutes, DemoUsersFrameRoutes, DemoGroupsFrameRoutes, DemoComponentsPageRoutes, DemoControlsFrameRoutes];
