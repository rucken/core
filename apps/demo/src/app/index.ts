...
export const RuckenDemoShareds: any[] = [DemoRoutes, RuckenDemoRuI18n, DemoEndpointHelper, DemoHttpHelper, DemoHomePageRoutes, DemoThemesPageRoutes, DemoAdminPageRoutes, DemoGroupsFrameRoutes, DemoUsersFrameRoutes, DemoComponentsPageRoutes, DemoControlsFrameRoutes, DemoAccountPageRoutes, DemoProfileFrameRoutes];
