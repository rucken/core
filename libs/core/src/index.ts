...
export const RuckenCoreShareds: any[] = [RuckenCoreRuI18n, EndpointStatusEnum, EndpointHelper, HttpHelper, RepositoryHelper, FontawesomeItemsMock, ThemeItemsMock, ContentType, Fontawesome, GroupPermission, Group, MetaModel, Permission, UserGroup, Theme, User, translate, isJson, inValues, BaseResourceModel];
