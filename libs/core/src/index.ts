...
export const RuckenCoreShareds: any[] = [RuckenCoreRuI18n, EndpointStatusEnum, HttpHelper, EndpointHelper, RepositoryHelper, Fontawesome, ContentType, GroupPermission, Group, MetaModel, Permission, Theme, UserGroup, User, FontawesomeItemsMock, ThemeItemsMock, translate, isJson, inValues, BaseResourceModel];
