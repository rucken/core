...
export const RuckenCoreShareds: any[] = [RuckenCoreRuI18n, translate, isJson, inValues, EndpointStatusEnum, EndpointHelper, HttpHelper, RepositoryHelper, FontawesomeItemsMock, ThemeItemsMock, ContentType, GroupPermission, Fontawesome, Group, MetaModel, Permission, Theme, UserGroup, User, BaseResourceModel];
