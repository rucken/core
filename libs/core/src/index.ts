...
export const RuckenCoreShareds: any[] = [RuckenCoreRuI18n, translate, isJson, inValues, EndpointStatusEnum, EndpointHelper, HttpHelper, RepositoryHelper, ContentType, Fontawesome, GroupPermission, Group, MetaModel, Permission, Theme, UserGroup, User, FontawesomeItemsMock, ThemeItemsMock, BaseResourceModel];
export const RuckenCoreServices: any[] = [AccountService, AppService, ContentTypesService, FontawesomeService, GroupPermissionsService, PermissionsService, ThemesService, GroupsService, UserGroupsService, UsersService, BaseLocalRepositoryService, BaseRemoteRepositoryService, BaseRepositoryService];
