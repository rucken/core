...
export const RuckenCoreShareds: any[] = [RuckenCoreRuI18n, BaseResourceModel, translate, isJson, inValues, EndpointStatusEnum, EndpointHelper, HttpHelper, RepositoryHelper, FontawesomeItemsMock, ThemeItemsMock, ContentType, Fontawesome, GroupPermission, Group, MetaModel, Permission, Theme, UserGroup, User];
export const RuckenCoreServices: any[] = [BaseLocalRepositoryService, BaseRemoteRepositoryService, BaseRepositoryService, AccountService, AppService, ContentTypesService, FontawesomeService, GroupPermissionsService, GroupsService, PermissionsService, ThemesService, TokenService, UserGroupsService, UsersService];
