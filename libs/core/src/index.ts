...
export const RuckenCoreServices: any[] = [AppService, AccountService, ContentTypesService, FontawesomeService, GroupPermissionsService, GroupsService, PermissionsService, ThemesService, TokenService, UserGroupsService, UsersService, BaseRemoteRepositoryService, BaseLocalRepositoryService, BaseRepositoryService];
